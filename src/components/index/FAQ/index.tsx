        ...
        <div className="md:w-full md:max-w-6xl">
          ...
          <div className="mt-14 space-y-6 md:flex md:flex-row md:justify-center md:space-y-0 md:space-x-6">
            <div className="space-y-6 md:w-1/2">
              ...
              >
                <Accordion.Answer>
                  {`หากต้องการอยู่ชมรมเดิม ให้กดปุ่มยืนยันสิทธิ์ชมรมเดิมในวันที่ 5 พ.ค. 65 ถึงวันที่ 6 พ.ค. 65 <a href="/FAQ?req=a"><strong>ดูรายละเอียดเกี่ยวกับโควตายืนยันสิทธิ์ชมรมเดิมได้ที่นี่</strong></a> สำหรับชมรมที่ไม่มีโควตายืนยันสิทธิ์ ก็ยังสามารถลงชื่อ Audition/ลงทะเบียนเข้าชมรมเดิมได้`}
                </Accordion.Answer>
              </Accordion>
              <Accordion
                Icon={AccordionIcon.Chevron}
