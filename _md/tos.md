...
1.  คำนิยาม
    ...
    1.1.  "เงื่อนไขฯ" หมายความว่า
          ข้อกำหนดและเงื่อนไขในการใช้งานระบบลงทะเบียนชมรม ฉบับนี้

    1.2.  "กช." หมายความว่า คณะกรรมการงานกิจกรรมพัฒนาผู้เรียน
           โรงเรียนเตรียมอุดมศึกษา

    1.3.  "ผู้ใช้" หมายความว่า นักเรียนปัจจุบัน โรงเรียนเตรียมอุดมศึกษา

    1.4.  "ระบบ" หมายความว่า ระบบลงทะเบียนชมรม

    1.5.  "เว็บไซต์" หมายความรวมถึง เว็บไซต์ แอปพลิเคชัน
           แพลตฟอร์มโซเชียลมีเดียอย่างเป็นทางการ หรือคุณสมบัติอื่น ๆ
           ทางออนไลน์ที่ กช. เป็นผู้จัดทำขึ้นมา

    1.6.  "บัญชี" หมายความว่า บัญชีที่ได้ลงทะเบียนไว้กับ กช.

    1.7.  "เนื้อหา" หมายความว่า ข้อมูลต่าง ๆ เช่น ข้อความ เสียง เพลง
        รูปภาพ วิดีโอ ซอฟต์แวร์ โปรแกรม และข้อมูลอื่น ๆ
        ที่เกี่ยวข้องกับระบบลงทะเบียนฯ เป็นต้น
    
    1.8.  "ข้อมูล" หมายความว่า ข้อมูลในลักษณะใด ๆ
        ...
        1.8.1.  การเก็บรวบรวมเพื่อการประมวลผลของอุปกรณ์นั้น
            หรือเพื่อเป็นส่วนหนึ่งของระบบข้อมูลเพื่อการประมวลผลนั้น

        1.8.2.  การประมวลผลโดยอุปกรณ์นั้นตามคำสั่งหรือโปรแกรมที่กำหนดไว้
    
    1.9.  "ข้อมูลส่วนบุคคล" หมายความว่า
...
5.  บัญชี
    ...
    5.2.  ในกรณีที่ผู้ใช้ลงทะเบียนข้อมูลการยืนยันตัวตนใด ๆ เมื่อใช้งานระบบ
    ...
    5.3.  กช. ขอสงวนสิทธิ์ในการลบบัญชีใด ๆ
    ...
    5.4.  บัญชีแต่ละบัญชีในการใช้งานระบบนั้น
    ...
    5.5.  กช. สงวนสิทธิ์ในการลบบัญชีใด ๆ
...
6.  การคุ้มครองข้อมูลส่วนบุคคล
    ...
    6.1.  ผู้ใช้ต้องอ่านและทำความเข้าใจ<a
        href="/privacy-policy">นโยบายความเป็นส่วนตัว</a>ก่อน
...
7.  การให้บริการระบบ
    ...
    7.4.  กช. ขอสงวนสิทธิในการแก้ไขหรือเปลี่ยนแปลงเงื่อนไขฯ
...
8.  สิทธิ์ของผู้ใช้
    ...
    8.1.  ผู้ใช้จะได้รับสิทธิ์ในการเลือกลงทะเบียนเข้าเป็นสมาชิกชมรมหรือลงชื่อ
        Audition ชมรมตามที่ต้องการได้

        8.1.1.  หากผู้ใช้ไม่ใช้ระบบของ กช. ในการลงทะเบียนชมรม
            จะทำให้ผู้ใช้ไม่มีสิทธิ์ที่ระบุไว้ในข้อ 8.1

9.  สิทธิ์ของชมรม

    9.1.  ชมรมมีสิทธิ์ในการเลือกผู้ใดก็ได้เข้าเป็นสมาชิกชมรมนอกกรอบเวลาหรือนอกกรอบเกณฑ์
        ที่ กช. ได้กำหนดไว้ 1 คน เท่านั้น ไม่ว่าจะด้วยเหตุผลใด ๆ ก็ตาม
        ทั้งนี้ เหตุผลนั้นก็ต้องไม่ขัดกับเงื่อนไขฯ ฉบับนี้ด้วย

        9.1.1.  ข้อ 9.1 นั้น มีไว้เพื่อรองรับข้อผิดพลาดของระบบ กล่าวคือ
...
10. ข้อจำกัดการใช้งาน
    ...
    10.1.  ผู้ใช้ไม่สามารถกระทำการดังต่อไปนี้เมื่อใช้งานระบบได้

        10.1.1.  การกระทำที่ฝ่าฝืนกฎหมาย ข้อบังคับ คำพิพากษา มติหรือคำสั่งศาล
            มาตรการทางปกครอง หรือข้อตกลงใด ๆ
            ที่มีผลผูกพันทางกฎหมายทั้งสิ้น

        10.1.2.  การกระทำที่ละเมิดสิทธิในทรัพย์สินทางปัญญา เช่น ลิขสิทธิ์
        ...
        10.1.3.  การกระทำที่แสดงหรือส่งต่อซึ่งการแสดงออกที่มีลักษณะรุนแรงหรือเกี่ยวข้องกับเพศอย่างชัดเจน
            ...
            พฤติกรรมการทำร้ายตัวเอง การใช้ยาในทางที่ผิด หรือการแสดงออกใด ๆ
            ซึ่งเป็นการต่อต้านสังคมอันประกอบด้วยเนื้อหาที่ต่อต้านสังคมและทำให้บุคคลอื่นเกิดความไม่สบายใจ
            เป็นต้น

        10.1.4.  การกระทำที่อาจทำให้ผู้อื่นเข้าใจผิดเกี่ยวกับ กช.
            หรือบุคคลภายนอกหรือการจงใจเผยแพร่ข้อมูลเท็จ

        10.1.5.  การกระทำที่เป็นการแลกเปลี่ยนสิทธิ์ในการใช้เนื้อหา เป็นเงินสด
            ทรัพย์สินหรือผลประโยชน์อื่น ๆ นอกเหนือจากที่ กช. กำหนดไว้

        10.1.6.  การกระทำที่มีการใช้ระบบ เพื่อการขาย การตลาด การโฆษณา
        ...
        10.1.7.  การกระทำที่เป็นการเก็บรวบรวม เปิดเผย
        ...
        10.1.8.  การกระทำซึ่งเป็นการแทรกแซงเครื่องแม่ข่ายหรือระบบเครือข่ายของการให้บริการระบบ
        ...
        10.1.9.  การถอดรหัสซอร์สโค้ดของบริการโดยวิธีวิศวกรรมย้อนกลับ
            การถอดประกอบ หรือสิ่งที่คล้ายคลึงกัน

        10.1.10. การกระทำที่ให้ความช่วยเหลือหรือส่งเสริมกิจกรรมใด ๆ
            ที่ระบุไว้ในข้อ 8.1.1 ถึงข้อ 8.1.9 ข้างต้น

        10.1.11. การกระทำอื่นใด นอกเหนือจากที่ระบุไว้ในข้อ 8.1.1 ถึงข้อ 8.1.9
            ที่ กช. เห็นว่าไม่เหมาะสม

    10.2.  การใช้งานระบบนั้น ต้องเป็นไปตามกรอบเวลาที่ กช.
    ...
    10.3.  ผู้ใช้ต้องใช้ระบบนี้ด้วยความเสี่ยงของตน
...
11. ความรับผิดชอบของผู้ใช้
    ...
    11.1.  ผู้ใช้ต้องใช้ระบบนี้ด้วยความเสี่ยงของตนและเป็นผู้รับผิดชอบแต่เพียงผู้เดียวต่อการกระทำทั้งหมดหรือการกระทำใด
        ๆ ที่กระทำไปอันเนื่องมาจากการใช้งานระบบนี้

    11.2.  กช. อาจระงับการให้บริการระบบทั้งหมดหรือบางส่วน ลบบัญชี
        ...
        11.2.1.  ผู้ใช้ละเมิดกฎหมายที่เกี่ยวข้อง กฎระเบียบ เงื่อนไขฯ ฉบับนี้

        11.2.2.  ผู้ใช้ทำให้ กช.
            เสื่อมเสียความน่าเชื่อถือโดยการเผยแพร่ข้อมูลเท็จ
            ใช้วิธีการโกง หรือวิธีการใด ๆ ทั้งสิ้น

        11.2.3.  กช. สูญเสียความไว้วางใจต่อผู้ใช้หรือเมื่อ กช.
...
13. ข้อจำกัดความรับผิดของ กช.
    ...
    13.1.  กช. จะไม่รับผิดชอบใด ๆ
        ต่อความเสียหายอันเกิดจากการกระทำของผู้ใช้ในการใช้งานระบบ
        เว้นแต่ความเสียหายดังกล่าวมีส่วนเกิดจากการกระทำโดยเจตนาของ กช.

    13.2.  กช. จะไม่รับผิดชอบใด ๆ
        ต่อความเสียหายอันเกิดขึ้นจากกรณีดังต่อไปนี้

        13.2.1.  ไม่ได้ลงทะเบียนชมรม หรือลงทะเบียนชมรมผิดพลาด
            เนื่องจากความเข้าใจคลาดเคลื่อนของผู้ใช้

        13.2.2.  ไม่ได้ลงทะเบียนชมรมในระยะเวลาที่ กช. กำหนด
            เพราะการลืมรหัสผ่านหรือข้อมูลที่จำเป็นต่อการลงทะเบียนชมรม

        13.2.3.  การประชาสัมพันธ์ข้อมูลข่าวสารผิดพลาดที่เกิดขึ้นจากชมรม
            โดยไม่มีส่วนเกี่ยวข้องกับ กช.

        13.2.4.  ไม่สามารถลงทะเบียนชมรมได้ เพราะ ขาดอุปกรณ์หรือบริการในข้อ
            7.1 หรือ อุปกรณ์หรือบริการดังกล่าวเกิดข้อผิดพลาด

        13.2.5.  การคัดเลือกสมาชิกชมรมนอกระยะเวลาที่ กช. กำหนด

        13.2.6.  ผู้ใช้ไม่ปฏิบัติตามกรอบเวลาที่ กช. ได้กำหนดไว้

        13.2.7.  ไม่ได้กดลงทะเบียนชมรมตั้งแต่แรก

        13.2.8.  ลงทะเบียนชมรมไม่ทัน

        13.2.9.  การลงทะเบียนชมรมผิดชมรม (รวมไปด้วยแต่ไม่จำกัดถึง
            การสำคัญผิดชื่อชมรม การสำคัญผิดในคุณสมบัติของชมรม)

        13.2.10. การกระทำอันเป็นผลมาจากความประมาทของผู้ใช้เอง

        13.2.11. ปัญหาใด ๆ ก็ตามที่มิได้เกิดขึ้นจากความผิดพลาดของระบบโดยตรง

        13.2.12. การ Audition ชมรมผ่าน แต่ไม่ได้กดลงชื่อ Audition ชมรมนั้นไว้

        13.2.13. การกดยืนยันเข้าเป็นสมาชิกชมรมที่ไม่มี Audition
            แต่ต้องการเข้าไปเป็นสมาชิกของชมรมที่มีการ Audition

        13.2.14. ไม่ดำเนินการลงทะเบียนชมรมใด ๆ เลย

        13.2.15. ไม่ใช้ระบบของ กช. ในการลงทะเบียนชมรม

        13.2.16. การไม่ผ่านการ Audition ชมรมใดเลย
            (ผู้ใช้จะมีสิทธิ์ในการเลือกอยู่ชมรมที่ไม่มีการ Audition แทน)

        13.2.17. การกดยืนยันสิทธิ์ชมรมเมื่อผ่านการ Audition หลายชมรม
            แต่ต้องการเป็นสมาชิกของชมรมอื่น

        13.2.18. การยืนยันในการสละสิทธิ์ใด ๆ ก็ตาม
            (หากทำไปแล้วจะย้อนกลับไปแก้ไขการสละสิทธิ์ไม่ได้
            ไม่ว่าด้วยกรณีใด ๆ ก็ตาม)

        13.2.19. กรณีอื่นใดที่เกิดขึ้นจากความผิดพลาดของระบบ
            แต่ผู้ใช้ไม่ได้บันทึกภาพหน้าจอ หรือบันทึกหลักฐานไว้ ตามที่
            กช. กำหนดไว้ หรือไม่แจ้งให้ กช. ทราบในระยะเวลาที่ กช. กำหนด

        13.2.20. กรณีอื่นใด นอกเหนือจากที่ระบุในข้อ 11.2.1 ถึงข้อ 11.2.19
            ที่ไม่ได้เกิดขึ้นจากความผิดพลาดของระบบ

    13.3.  ในกรณีผู้ใช้ได้รับความเสียหายอันเนื่องมาจากการกระทำโดยประมาทของ
...
14. ความสัมพันธ์ระหว่างกฎหมาย กฎระเบียบ และเงื่อนไขฯ ฉบับนี้
    ...
    14.1.  ในกรณีที่ข้อหนึ่งข้อใดของเงื่อนไขฯ
    ...
    14.2.  ผู้ใช้อยู่ภายใต้กฎหมายของราชอาณาจักรไทยทุกฉบับที่มีผลบังคับใช้
        (รวมไปถึงแต่ไม่จำกัดเพียง พ.ร.บ.
        ว่าด้วยการกระทำความผิดเกี่ยวกับคอมพิวเตอร์ พ.ศ. 2550)

15. การแจ้งเตือนและการติดต่อ

    15.1.  สำหรับการแจ้งเตือนจาก กช. ต่อผู้ใช้เกี่ยวกับระบบ กช.
        อาจใช้วิธีการที่ กช. เห็นว่าเหมาะสม

    15.2.  สำหรับการแจ้งเตือนจาก กช. ต่อผู้ใช้เกี่ยวกับระบบ
        ผู้ใช้มีหน้าที่ต้องติดตามข่าวสารและการอัปเดตรายละเอียดต่าง ๆ จาก
        กช. อย่างสม่ำเสมอ

    15.3.  สำหรับการแจ้งเตือนจากชมรม ต่อผู้ใช้เกี่ยวกับระบบ
