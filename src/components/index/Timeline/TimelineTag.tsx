...
const TimelineTag = ({
  ...
  if (description !== "" && title === "" && subTitle === "") {
    cname =
      "rounded-lg border border-opacity-40 border-TUCMC-gray-700 mt-4 mb-3 px-6 w-full"
  } else {
    cname =
      "rounded-lg border border-opacity-40 border-TUCMC-gray-700 px-6 w-full"
  }
  ...
  return (
    <div className={`flex flex-row space-x-4 ${padding}`}>
      ...
      <div className={cname}>
        {title !== "" && (
          <h1 className="pt-4 font-bold tracking-tight">{title}</h1>
        )}
        {subTitle !== "" && (
          <p
            className={
              title !== ""
                ? "tracking-tight text-TUCMC-gray-900"
                : "pt-4 tracking-tight text-TUCMC-gray-900"
            }
          >
            {subTitle}
          </p>
        ...
        <p
          className={
            subTitle !== ""
              ? "mt-4 tracking-tight text-TUCMC-gray-700"
              : "mt-2 tracking-tight text-TUCMC-gray-700"
          }
        >
          {description}
        </p>
        {((exdes !== null && exdes !== undefined && exdes.length !== 0) ||
          title !== "" ||
          subTitle !== "") && (
          <p className="my-4 text-sm tracking-tight text-TUCMC-gray-700">
            {exdes}
          </p>
        )}
      </div>
