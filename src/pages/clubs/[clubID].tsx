...
export const getStaticProps: GetStaticProps = async ({params}) => {
  ...
  return {
    props: {
      data: {
        ...clubData, description: parseText(clubData.description), reviews: clubData.reviews.map(rev => {
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex space-x-2 text-TUCMC-gray-600">
                        ...
                        <div className="hidden md:block lg:hidden">
                          ...
                          <Modal TriggerRef={contactRef} overlayClassName="flex justify-end"
                                 className="shadow-md rounded-lg absolute bg-white w-[300px] mt-1 px-4 py-3 z-20">
            ...
            <div className="px-6 space-y-12 md:space-y-16 pb-24 pt-11 md:pt-12">
              <div>
                <article dangerouslySetInnerHTML={{__html: `${data.description}`}}
                         className="font-texts prose text-TUCMC-gray-700 space-y-4 text-[1.05rem]">
              ...
              <div className="space-y-8 md:space-y-0 md:flex md:space-x-4 md:justify-center">
                {
                  images.map((name, index) => {
                    if (name.includes("picture")) return <div key={`picture-${index}`}>
                      <Image priority={true} onLoad={loaded} className="rounded-lg object-cover"
                             src={`/assets/images/clubs/${clubID}/${name}`} width="768"
                             height="432"/>
                    </div>
                  })
                }
                  ...
                  “
                          ...
                          <div className="px-6 shadow-lg bg-whtie rounded-xl md:pt-12 md:pb-16 md:px-16">
                            ...
                            <article dangerouslySetInnerHTML={{__html: `${revContent.context}`}}
                                     className="font-texts prose text-gray-500 text-[1.05rem]">
                            </article>
