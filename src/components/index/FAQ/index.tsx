          ...
          <h1 className="font-bold text-2xl text-center">คำถามที่พบบ่อย</h1>
            <div
              ...
              <div className="space-y-6 md:w-1/2">
                <FAQElement title="นักเรียนสามารถอยู่ได้กี่ชมรม" indexFAQ={true}>
                  <FAQElement.Answer>
                    1 ชมรมเท่านั้น
                  </FAQElement.Answer>
                </FAQElement>
                <FAQElement title="สามารถเปลี่ยนชมรมระหว่างปีการศึกษาได้หรือไม่" indexFAQ={true}>
                  <FAQElement.Answer>
                    ไม่สามารถเปลี่ยนชมรมระหว่างปีการศึกษาได้ แต่สามารถเลือกเข้าชมรมใหม่หลังจบปีการศึกษาได้
                  </FAQElement.Answer>
                </FAQElement>
                <FAQElement title="นักเรียน ม.5 และ ม.6 หากต้องการอยู่ชมรมเดิมต้องทำอย่างไร" indexFAQ={true}>
                  <FAQElement.Answer>
                ...
                <FAQElement title="หากต้องการรอการประกาศผลสำรอง จะต้องสละสิทธิ์ชมรมที่ผ่านการ Audition ทั้งหมดใช่หรือไม่" indexFAQ={true}>
                  <FAQElement.Answer>
              ...
              <div className="space-y-6 md:w-1/2">
                <FAQElement title="สามารถเลือกชมรมที่มีการ Audition และไม่มีการ Audition พร้อมกันได้หรือไม่" indexFAQ={true}>
                  <FAQElement.Answer>
                ...
                <FAQElement title="ลงชื่อ Audition ในเว็บไซต์ระบบลงทะเบียนชมรมไว้แล้วจำเป็นต้องลงชื่อ Audition ที่ชมรม หรือที่ไหนอีกไหม" indexFAQ={true}>
                  <FAQElement.Answer>
                    บางชมรมอาจต้องมีการลงชื่อ Audition เพิ่มเติม ซึ่งนักเรียนสามารถดูรายละเอียดได้จากช่องทางประชาสัมพันธ์ของชมรมนั้นโดยตรง
                  </FAQElement.Answer>
                </FAQElement>
                <FAQElement title="ติดตามรายละเอียดการ Audition ของแต่ละชมรมได้จากที่ไหน" indexFAQ={true}>
                  <FAQElement.Answer>
                    ติดตามได้ที่ช่องทางการประชาสัมพันธ์ของชมรมโดยตรง (ตรวจสอบช่องทางประชาสัมพันธ์ของชมรมได้ที่หน้าแนะนำชมรมของแต่ละชมรม)
                  </FAQElement.Answer>
                </FAQElement>
                <FAQElement title="ถ้าลงทะเบียนชมรมไม่ทันจะต้องทำอย่างไร" indexFAQ={true}>
                  <FAQElement.Answer>
