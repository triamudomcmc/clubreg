export const Ellipsis = ({inverted = false, ...restProps}) => {
  return (
    inverted ? <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
         style={{margin: "auto", shapeRendering: "auto"}} viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" {...restProps}>
