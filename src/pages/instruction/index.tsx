          ...
          <div className="flex flex-col space-y-10">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-TUCMC-red-500">*นักเรียน ม.5 และ ม.6 สามารถเลือกใช้โควตายืนยันสิทธิ์ชมรมเดิมได้ภายในวันที่  2564 เท่านั้น</p>
                <p className="text-TUCMC-red-500">*สามารถเลือกชมรมที่สนใจได้จนถึงวันที่ 21 มิ.ย.. 2564 เวลา 23.59 น. เท่านั้น นักเรียนที่ไม่ลงชื่อ Audition หรือลงทะเบียนเข้าชมรมใดเลย ระบบจะทำการสุ่มชมรมให้อัตโนมัติ ในวันที่ 26 มิ.ย. 2564 โดยจะสุ่มเป็นชมรมที่ไม่มีการ Audition และยังมีที่นั่งว่างอยู่เท่านั้น</p>
            ...
            <div className="flex space-x-4">
              <h1>3.</h1>
              <p>สำหรับนักเรียนที่ลงชื่อ Audition เอาไว้ ให้ไป Audition ตามวันเเละเวลาที่แต่ละชมรมกำหนด และรอติดตามประกาศผลการ Audition ในวันที่ 22 มิ.ย. 2564 เวลา 7.30 น.
            ...
            <div className="flex space-x-4">
              <h1>4.</h1>
              <p> ทุกชมรมประกาศผลการ Audition พร้อมกันบนเว็บไซต์ในวันที่ 22 มิ.ย. 2564 เวลา 7.30 น. โดยนักเรียนสามารถตรวจสอบผลได้หลังจากเข้าสู่ระบบแล้ว</p>
            </div>
            <div className="flex mx-auto">
              <div className="max-w-[300px]">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p>
                  4.2. หากมีทั้งชมรมที่ผ่านการ Audition และติดสำรอง นักเรียนสามารถเลือกได้ว่าจะเข้าชมรมที่ผ่านการ Audition เลย หรือรอลุ้นผลสำรองในวันที่ 23 และ 24 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p className="text-TUCMC-red-500">
                  *หากไม่ยืนยันสิทธิ์ชมรมที่ผ่านการ Audition ภายในวันที่ 22 มิ.ย. 2564 เวลา 23.59 น. จะถือว่าสละสิทธิ์ชมรมที่ผ่านการ Audition โดยอัตโนมัติ และจะไม่สามารถกลับมายืนยันสิทธิ์ชมรมนั้นได้อีก
                </p>
                <p>
                  4.3. หากติดสำรองทุกชมรมที่ลงชื่อ Audition ไว้ ให้รอลุ้นผลสำรองสองรอบในวันที่ 23 และ 24 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p>
                  4.4. หากไม่ผ่านการ Audition และไม่ติดสำรองชมรมใดเลย ให้เลือกเข้าชมรมที่ไม่มีการ Audition เเละยังมีที่ว่างเหลืออยู่ในวันที่ 25 มิ.ย. 2564
                </p>
              </div>
            </div>
            <div className="flex space-x-4">
              <h1>5.</h1>
              <p>
                การประกาศผลสำรองจะมีทั้งหมด 2 รอบ รอบแรกในวันที่ 23 มิ.ย. 2564 เวลา 7.30 น. และรอบ 2 ในวันที่ 24 มิ.ย. 2564 เวลา 7.30 น. <span className="text-TUCMC-green-500">โดยนักเรียนสามารถตรวจสอบผลได้หลังจากเข้าสู่ระบบแล้ว</span>
              </p>
            </div>
            <div className="flex mx-auto">
              <div className="max-w-[300px]">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p>
                  5.2. หากมีทั้งชมรมที่ผ่านการ Audition (สำรองรอบที่ 1) และชมรมที่ยังคงติดสำรองอยู่ (กรณี Audition หลายชมรม) นักเรียนสามารถเลือกได้ว่าจะเข้าชมรมที่ผ่านการ Audition (สำรองรอบที่ 1) เลย หรือรอลุ้นผลสำรองรอบที่ 2 ในวันที่ 24 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p className="text-TUCMC-red-500">
                  *หากไม่ยืนยันสิทธิ์ชมรมที่ผ่านการ Audition ภายในวันที่ 23 มิ.ย. 2564 เวลา 23.59 น. จะถือว่าสละสิทธิ์ชมรมที่ผ่านการ Audition (สำรองรอบที่ 1) โดยอัตโนมัติ และจะไม่สามารถกลับมายืนยันสิทธิ์ชมรมนั้นได้อีก
                </p>
                <p>
                  5.3. หากยังไม่ถูกเรียกสำรองรอบที่ 1 สามารถรอลุ้นผลสำรองรอบที่ 2 ในวันที่ 24 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p>
                  5.4. หลังจากประกาศผลสำรองรอบที่ 2 หากผ่านการ Audition (สำรองรอบที่ 2) ให้เลือกยืนยันสิทธิ์ หรือสละสิทธิ์ชมรมนั้น ๆ
                </p>
                <p className="text-TUCMC-red-500">
                  *หากไม่ยืนยันสิทธิ์ชมรมที่ผ่านการ Audition ภายในวันที่ 24 มิ.ย. 2564 เวลา 23.59 น. จะถือว่าสละสิทธิ์ชมรมที่ผ่านการ Audition (สำรองรอบที่ 2) โดยอัตโนมัติ และจะไม่สามารถกลับมายืนยันสิทธิ์ชมรมนั้นได้อีก
                </p>
                <p>
                  5.5. หลังจากประกาศผลสำรองรอบที่ 2 หากไม่ผ่านการ Audition ชมรมใดเลย ให้เลือกเข้าชมรมที่ไม่มีการ Audition เเละยังมีที่ว่างเหลืออยู่ในวันที่ 25 มิ.ย. 2564
                </p>
              </div>
            </div>
            <div className="flex space-x-4">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-TUCMC-red-500">
                  *หากไม่เลือกลงทะเบียนชมรมภายในวันที่ 25 มิ.ย. 2564 เวลา 23.59 น. ระบบจะทำการสุ่มชมรมให้โดยอัตโนมัติ และจะไม่สามารถกดเลือกชมรมใดได้อีก
                </p>
              </div>
            </div>
            <div className="flex space-x-4">
            ...
            <div className="flex space-x-4">
              <h1>9.</h1>
              <p>
                เริ่มเรียนชมรมคาบแรกในวันที่ 28 มิ.ย. 2564 ตรวจสอบรายละเอียดเกี่ยวกับสถานที่เรียนชมรม หรือกิจกรรมของชมรมได้ผ่านทางช่องทางประชาสัมพันธ์ของชมรม
              </p>
            </div>
          </div>
        </div>
