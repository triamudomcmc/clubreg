...
//             font-family: 'Noto Sans Thai', 'Open Sans', Arial, sans-serif !important;
//         }
...
//         style="font-family: 'Noto Sans Thai', 'Open Sans', Arial, sans-serif;">
//         <tr>
//             <td>
...
//                                         <h1 style="color:#1e1e2d; font-weight:600; margin:0;font-size:32px;font-family:'Noto Sans Thai', 'Open Sans', Arial, sans-serif;">มีคำขอแก้ไขรหัสผ่าน</h1>
//                                         <span
...
//                                         </p>
//                                         <a href="${url}"
//                                             style="background:#f687b3;text-decoration:none !important; font-weight:600; margin-top:35px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;font-family:'Noto Sans Thai', 'Open Sans', Arial, sans-serif;">เปลี่ยนรหัสผ่าน</a>
//                                     </td>
//                                 </tr>
//                                 <tr>
//                                     <td style="height:40px;">&nbsp;</td>
...
//                             <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;font-family:'Noto Sans Thai', 'Open Sans', Arial, sans-serif;"><strong>งานกิจกรรมพัฒนาผู้เรียน โรงเรียนเตรียมอุดมศึกษา</strong></p>
//                         </td>
//                     </tr>
//                     <tr>
//                         <td style="height:80px;">&nbsp;</td>
