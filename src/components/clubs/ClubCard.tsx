...
export const ClubCard = ({data, imageLoadAction = null}) => {
  ...
  return (
    <motion.div whileHover={{scale: 1.03}} whileTap={{scale: 0.97}}
                onClick={click}
                className="flex flex-col rounded-lg mx-1 marg:mx-[0.35rem] my-[0.35rem] shadow-lg w-full max-w-[260px] minClubs2:w-175px minClubs:w-185px cursor-pointer">
      {imageLoadAction ?
        <Image priority={false} onLoad={imageLoadAction} className="object-cover rounded-t-lg w-full" width="260" height="143"
