...
export const ClubCard = ({audition = false}) => {
  return(
    <div style={{width: "185px"}} className="flex flex-col rounded-lg minClubs2:mx-1 my-1 mx-10 shadow-md w-fullI minClubs:w-185px minClubs2:w-175px">
      <img className="object-cover rounded-t-lg w-fullI minClubs:w-185px minClubs2:w-175px" width="185" height="102" src="/assets/images/placeholder/thumb1.png"/>
