...
export default establishNextApi("POST", [updateTransferStatusBridge.init(updateTransferStatusAction, checkTranferActionSubmit),loadTransferStatusBridge.init(loadTransferStatus, checkPanel)])
