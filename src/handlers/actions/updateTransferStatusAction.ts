...
const removeFromUser = async (data, taskData) => {
  ...
  if (panel.length <= 0) {panel = FieldValue.delete()}
...
export const updateTransferStatusAction = updateTransferStatusBridge.helper.createAction(async (ApiParams, parameters, ConditionParams) => {
