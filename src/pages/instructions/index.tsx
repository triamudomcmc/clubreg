    ...
    <PageContainer>
      ...
      <div className="relative max-w-6xl pt-8 pb-16 mx-auto">
        <div className="absolute z-20 w-full h-full bg-gray-100 bg-opacity-30 backdrop-filter backdrop-blur">
          ...
          <p className="text-2xl font-bold text-center text-TUCMC-gray-800">รอติดตามวิธีใช้ระบบลงทะเบียนชมรม<br/>อย่างละเอียดในภายหลัง</p>
          </div>
          </div>
        </div>
        <h1 className="mb-6 text-2xl font-bold text-center md:my-12">วิธีลงทะเบียน</h1>
        <div className="flex flex-col items-center px-8 space-y-8 font-texts text-TUCMC-gray-700">
          ...
          <div className="flex flex-col space-y-10">
            <div className="flex space-x-4">
              <h1>1.</h1>
              <p>
                เข้าสู่ระบบ : นักเรียน<span className="underline">ทุกระดับชั้น</span>จะต้องสร้างบัญชีผู้ใช้งานใหม่
                โดยการกดที่ปุ่ม ‘เข้าสู่ระบบ’ {">"} สร้างบัญชีใหม่ {">"} กรอกรายละเอียดตามที่ระบุไว้ {">"} กดที่ปุ่ม
                ‘ยืนยันตัวตน’
              </p>
            </div>
            <div className="flex space-x-4">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <p>
                  สามารถดูข้อมูล รีวิว และรายละเอียดต่าง ๆ ของชมรมประกอบการตัดสินใจได้โดยการกดเข้าไปที่ชมรมที่ต้องการ
                  จากนั้นกดปุ่ม ‘ดูรายละเอียดชมรม’
                </p>
                <p>
                  2.1. สำหรับนักเรียน ม.4 ให้เลือกลงทะเบียนชมรมที่สนใจ หากเป็นชมรมที่ไม่มีการ Audition
                  และยังมีที่นั่งว่างอยู่ สามารถกดปุ่ม ‘ลงทะเบียน’ เพื่อเข้าชมรมนั้นได้ทันที แต่หากเป็นชมรมที่มีการ
                ...
                <p>
                  ...
                  ให้เลือกลงทะเบียนชมรมที่สนใจ หากเป็นชมรมที่ไม่มีการ Audition และยังมีที่นั่งว่างอยู่ สามารถกดปุ่ม
                  'ลงทะเบียน' เพื่อเข้าชมรมนั้นได้ทันที แต่หากเป็นชมรมที่มีการ Audition นักเรียนจะต้องกดปุ่ม 'ลงชื่อ
                  Audition' ไว้ก่อน แล้วจึงไป Audition ตามวันเวลาและสถานที่ที่ชมรมนั้น ๆ กำหนด โดยติดตามรายละเอียดการ
                  Audition ได้จากช่องทางประชาสัมพันธ์ของชมรมนั้น ๆ โดยตรง
                </p>
                <p className="text-TUCMC-green-500">*สามารถลงชื่อ Audition กี่ชมรมก็ได้</p>
                ...
                <p className="text-TUCMC-red-500">
                  *สามารถเลือกชมรมที่สนใจได้จนถึงวันที่ 14 มิ.ย. 2564 เวลา 23.59 น. เท่านั้น นักเรียนที่ไม่ลงชื่อ
                  Audition หรือลงทะเบียนเข้าชมรมใดเลย ระบบจะทำการสุ่มชมรมให้อัตโนมัติ ในวันที่ 19 มิ.ย. 2564
                  โดยจะสุ่มเป็นชมรมที่ไม่มีการ Audition และยังมีที่นั่งว่างอยู่เท่านั้น
                </p>
                <p className="text-TUCMC-red-500">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p>
                  ...
                  Audition เลย หรือรอลุ้นผลสำรองในวันที่ 31 พ.ค. และ 1 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p className="text-TUCMC-red-500">
                ...
                <p>
                  4.3. หากติดสำรองทุกชมรมที่ลงชื่อ Audition ไว้ ให้รอลุ้นผลสำรองสองรอบในวันที่ 16 และ 1 มิ.ย. 2564 เวลา
                  7.30 น.
                </p>
                <p>
            ...
            <div className="flex space-x-4">
              <h1>5.</h1>
              <p>
                การประกาศผลสำรองจะมีทั้งหมด 2 รอบ รอบแรกในวันที่ 31 พ.ค. 2566 เวลา 7.30 น. และรอบ 2 ในวันที่ 2 มิ.ย.
                2566 เวลา 7.30 น.{" "}
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <p>5.1. หากผ่านการ Audition (สำรองรอบที่ 1) ให้เลือกว่าจะยืนยันสิทธิ์กับชมรมใด</p>
                <p>
                  ...
                  หรือรอลุ้นผลสำรองรอบที่ 2 ในวันที่ 1 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p className="text-TUCMC-red-500">
                ...
                <p>
                  5.3. หากยังไม่ถูกเรียกสำรองรอบที่ 1 สามารถรอลุ้นผลสำรองรอบที่ 2 ในวันที่ 1 มิ.ย. 2564 เวลา 7.30 น.
                </p>
                <p>
                ...
                <p className="text-TUCMC-red-500">
                  *หากไม่ยืนยันสิทธิ์ชมรมที่ผ่านการ Audition ภายในวันที่ 1 มิ.ย. 2564 เวลา 23.59 น.
            ...
            <div className="flex space-x-4">
              <h1>6.</h1>
              <p>
                สำหรับนักเรียนที่ไม่ผ่านการ Audition ชมรมใดเลย หรือสละสิทธิ์ทุกชมรมที่ผ่านการ Audition
            ...
            <div className="flex space-x-4">
              <h1>7.</h1>
              <p>
                เมื่อยืนยันการลงทะเบียนแล้ว จะถือว่าเสร็จสิ้นการลงทะเบียนชมรม และเป็นสมาชิกของชมรมนั้นแล้ว
            ...
            <div className="flex space-x-4">
              ...
              <div>
                <p>
                  ตรวจสอบความถูกต้องของชมรมตนเอง หากมีข้อสงสัย สามารถติดต่อชมรมได้โดยตรง
                  หรือติดต่องานกิจกรรมพัฒนาผู้เรียน (กช.) ผ่านทาง
                </p>
                <p>
                  Facebook :{" "}
                  <a
